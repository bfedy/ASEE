...
leks <- read.table("DATA/140123wysg_leks.csv", sep=",", header=TRUE,quote="",comment.char="", 
...
It is useful to check the format of your data. <mark>We previously discussed some of the potential issues of storing columns as factors</mark>. Check to see if any columns are stored as factors. If needed re-import the data so that no columns are factors.  
